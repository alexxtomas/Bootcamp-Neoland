...
const RPGGames = videogames.filter(({genders}) => genders.includes('RPG'))
const howManyRPGGames = RPGGames.length
const RPGAverageScores = RPGGames.reduce((acc, {score}) => acc + score, 0)
								 / howManyRPGGames
